...
## Trial description
First, a fixation cross was shown at the center of the screen for 300 msec, which was followed by the reference category for half a second. Following the appearance of the category, the target character was shown for 200 msec, which was then followed by the mask (300 msec). The mask was included after piloting indicated that the task was likely too easy to yield reliable differences in accuracy or RT. Participants were then prompted to respond (indefinitely) as to whether the target character belonged to the reference category ("n"/RED for "no", and "z"/GREEN for "yes"). After a response was provided, a new trial began after 200 msec. Participants were allowed to take a break in between trials when one was desired, though none did.
